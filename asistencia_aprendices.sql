...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-08-2026 a las 23:03:18
...
--
-- Error leyendo la estructura de la tabla asistencia_aprendices.ficha: #1932 - Table &#039;asistencia_aprendices.ficha&#039; doesn&#039;t exist in engine
-- Error leyendo datos de la tabla asistencia_aprendices.ficha: #1064 - Algo está equivocado en su sintax cerca &#039;FROM `asistencia_aprendices`.`ficha`&#039; en la linea 1
